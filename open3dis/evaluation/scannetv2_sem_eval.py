...
CLASS_LABELS = ['wall', 'floor', 'cabinet', 'bed', 'chair', 'sofa', 'table', 'door', 'window', 'bookshelf', 'picture', 'counter', 'desk', 'curtain', 'refrigerator', 'shower curtain', 'toilet', 'sink', 'bathtub']
...
class Scannetv2SemEval(object):
    def __init__(self, num_class = 19, ignore_label = -100, predsem_path = None, feature = None, exp = None,  gtsem_path = None, pos_thres = None):
        ...
        for scene_idd in scenes:
            ...
            for class_folder in sem_res:
                ...
                with torch.no_grad(), torch.cuda.amp.autocast():
                    ...
                    confusion_table[:, index] = (50.0 * point_features.half().cuda() @ text_features.T).softmax(dim=-1)[:,0]
...
if __name__ == "__main__":
    ...
    eval = Scannetv2SemEval(num_class = 19, ignore_label = -100, predsem_path = args.predsem_path, feature = args.feature_stage, exp = args.exp, gtsem_path = args.gtsem_path, pos_thres = args.positive_thresh)
