...
from feature_fusion.utils_torch import resolve_overlapping_masks, \
...
data_path = "../Dataset/ScannetV2/ScannetV2_2D_5interval/version_graph_312scenes/final_result_graph3d_simple_feat_nospp"
...
for scene in scenes:
    ...
    data = torch.load(f"/home/tdngo/Workspace/3dis_ws/Mask3D/results/mask3d_scannet200_topk100/{scene.split('.')[0]}.pth")
