...
# Benchmark: Instance category Scannetpp
INSTANCE_BENCHMARK84_SCANNET_PP = [
    'table',
    'door',
    'ceiling lamp',
    'cabinet',
...
# Benchmark: Semantic + Instance ~ Just like Scannet200 @ Shift semantic to front
...
# Semantic + Instance ~ Just like Scannet200 @ Shift semantic to front
SEMANTIC_INSTANCE_CAT_SCANNET_PP = [
    'wall', 'ceiling', 'floor', 'fake ceiling', 'construction materials', 'pipes', 'joined tables', 'false ceiling', 'ceiling lights', 'papers', 'cardboards', 'electrical control panels', 'wall /other room', 'paper towels', 'wooden planks', 'wood planks', 'ceiling cables', 'power cables', 'jackets', 'files', 'boxes', 'ceiling lamps', 'dishes', 'beverage crates', 'mattresses', 'plates', 'pictures', 'documents', 'bags', 'paper trays', 'flowers', 'tube lights', 'power sockets', 'rods', 'drawers', 'curtain rails', 'file shelves', 'magazines', 'filefolders', 'rolled papers', 'stools', 'kitchen utensils', 'wall hooks', 'trash cans', 'bulletin boards', 'water pipes', 'condiments', 'tools', 'coat hangers', 'paintings', 'cushions', 'dumbbells', 'paper files', 'posters', 'notebooks', 'spice jars', 'keyboards', 'anti splatter shield', 'towels', 'cutting boards', 'stack of tyres', 'pile of papers', 'paper towel rolls', 'notes', 'utensils', 'toilet papers', 'postcards', 'floor mats', 'cloths', 'wall mounts', 'milk cartons', 'wooden shelves', 'pens', 'brushes', 'apples', 'sticky notes', 'toy models', 'envelopes', 'green vegetables', 'onions', 'paper packages', 'coasters', 'light switches', 'sockets', 'wet wipes', 'weights', 'jars', 'magnets', 'radiator pipes', 'straws', 'paper rolls', 'shelves', 'tissues', 'speakers', 'eggs', 'switches', 'cardboard boxes', 'paper notes', 'whiteboard pens', 'fruits', 'weight plates', 'light switchs', 'oven controls', 'decoration pieces', 'flushes',
    "door",
    "table",
    "cabinet",
    "ceiling lamp",
