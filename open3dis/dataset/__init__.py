...
from open3dis.dataset.arkitscenes_loader import ArkitScenesReader

__all__ = ["ReplicaReader", "ScanNetReader", "S3DISReader", "ArkitScenesReader" "build_dataset"]
...
def build_dataset(root_path, cfg):
    if cfg.data.dataset_name == "scannet200" or cfg.data.dataset_name == "scannetpp" or cfg.data.dataset_name == 'scannetpp_benchmark':
        ...
        return ArkitScenesReader(root_path, cfg)
    else:
